...
\begin{eg}
	...
	\begin{align*}
		p_{X_{1},\cdots,X_{n}}(x_{1},\cdots,x_{n}|\theta)=\prod_{i=1}^{n}\prob(X_{i}=x_{i}|\theta)&=\theta^{\sum_{i=1}^{n}x_{i}}(1-\theta)^{n-\sum_{i=1}^{n}x_{i}}\times 1\\
...
\begin{eg}
	...
	\end{align*}
	Therefore, $S=X_{(n)}$ is sufficient.
\end{eg}
\begin{eg}
	Let $\{X_{1},\cdots,X_{n}\}$ be a random sample of size $n$ from $\U[\theta-\frac{1}{2},\theta+\frac{1}{2}]$, where $\theta\in\mathbb{R}$ is unknown. The joint PDF of the random sample is:
	\begin{align*}
...
\end{eg}
\begin{eg}
	Let $\{X_{1},\cdots,X_{n}\}$ be a random sample of size $n$ from $\U[\theta_{1},\theta_{2}]$, where $\theta_{1},\theta_{2}\in\mathbb{R}$ are unknown with $\theta_{1}<\theta_{2}$ and $\theta_{1}$ is not a function of $\theta_{2}$. The joint PDF of the random sample is:
	\begin{align*}
...
\begin{eg}
	...
	Therefore, we have:
	\begin{equation*}
		\E\left(X_{1}=1\left|\sum_{i=1}^{n}X_{i}=s\right.\right)=\prob\left(X_{1}=1\left|\sum_{i=1}^{n}X_{i}=s\right.\right)=1-\prob\left(X_{1}=0\left|\sum_{i=1}^{n}X_{i}=s\right.\right)=\frac{s}{n}
	\end{equation*}
...
\begin{eg}
	...
	\begin{equation*}
		f(x|\mu,\sigma^{2})=\frac{1}{\sqrt{2\pi\sigma^{2}}}\exp\left(-\frac{(x-\mu)^{2}}{2\sigma^{2}}\right)=\exp\left(-\frac{\mu^{2}}{2\sigma^{2}}-\frac{1}{2}\ln(2\pi\sigma^{2})-\frac{1}{2\sigma^{2}}x^{2}+\frac{\mu}{\sigma^{2}}x\right)
	\end{equation*}
...
\begin{eg}
	...
	\begin{align*}
		...
		\int_{0}^{\infty}h(x)\frac{\theta^{n}}{\Gamma(n)}x^{n-2}e^{-\theta x}\,dx&=1\\
